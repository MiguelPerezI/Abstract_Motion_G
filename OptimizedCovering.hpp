...
class OptimizedCovering {
	...
	public:
        ...
        void runOptimizedCovering_CORE(SubComplexJ L, Complex K, SimplicialMap a, SimplicialMap b, int M, int Ns, double r, int argc, char **argv) {
